...
module MD5 = struct
  ...
  external update   : ctx -> buffer -> off -> len -> unit = "caml_nc_md5_update"   "noalloc"
...
module SHA1 = struct
  ...
  external update   : ctx -> buffer -> off -> len -> unit = "caml_nc_sha1_update"   "noalloc"
...
module SHA224 = struct
  ...
  external update   : ctx -> buffer -> off -> len -> unit = "caml_nc_sha224_update"   "noalloc"
...
module SHA256 = struct
  ...
  external update   : ctx -> buffer -> off -> len -> unit = "caml_nc_sha256_update"   "noalloc"
...
module SHA384 = struct
  ...
  external update   : ctx -> buffer -> off -> len -> unit = "caml_nc_sha384_update"   "noalloc"
...
module SHA512 = struct
  ...
  external update   : ctx -> buffer -> off -> len -> unit = "caml_nc_sha512_update"   "noalloc"
