...
(* OASIS_START *)
(* DO NOT EDIT (digest: 669fbf601eabe8d54b29a6795e8739dd) *)
(*
...
let setup_t =
  {
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "(\145m}\011\160 \003\225w|\188bL\156\030";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
