...
(* OASIS_START *)
(* DO NOT EDIT (digest: 5613dd1823e9b63c0414bc971aeac2bd) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          description =
            Some
              [
                 OASISText.Para
                   "Crypto? And _without_ objects? It's more likely than you think!"
              ];
          categories = [];
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "\247\164M\252\254\017]s\005\135h\237\127\146.\247";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
