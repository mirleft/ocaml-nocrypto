...
(* OASIS_START *)
(* DO NOT EDIT (digest: 95371cc9fe9d8c3077031f097266a405) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "Use CPU extensions";
                      flag_default = [(OASISExpr.EBool true, true)]
                   });
               Flag
                 ({
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\170-\149\213e\211\187@\237W\233\006\147j.\186";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
