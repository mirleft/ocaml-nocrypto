...
(* OASIS_START *)
(* DO NOT EDIT (digest: c2407237cd2ba837dc2638c3506766ba) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "Build Lwt/Unix support";
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "Use CPU extensions (SSE2, AES-NI)";
                      flag_default = [(OASISExpr.EBool true, true)]
                   });
               Flag
                 ({
                 ...
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage
                             ("cstruct",
                               Some (OASISVersion.VGreaterEqual "1.6.0"));
                   ...
                   },
                   {
                      ...
                      lib_internal_modules =
                        ["Native"; "Fortuna"; "Hmac_drgb"; "Gcm"; "Ccm"];
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Nocrypto_entropy_unix"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "nocrypto";
                      lib_findlib_name = Some "unix";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "nocrypto_lwt";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      bs_build =
                        [
                           (OASISExpr.EBool true, false);
                           (OASISExpr.EAnd
                              (OASISExpr.EFlag "unix", OASISExpr.EFlag "lwt"),
                             true)
                        ];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "lwt/";
                   ...
                   {
                      lib_modules = ["Nocrypto_entropy_lwt"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "nocrypto";
                 ...
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "nocrypto";
                           FindlibPackage ("mirage-entropy-xen", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources =
                        [
                   ...
                   {
                      lib_modules = ["Nocrypto_entropy_xen"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "nocrypto";
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["Notest"; "Hmac_tests"; "Dsa_tests"; "Testlib"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = None;
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      ...
                      src_repo_browser =
                        Some "https://github.com/mirleft/ocaml-nocrypto";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "CJN\200+\200\199\163\025Y\207\001\190\195\181\246";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
