...
(* OASIS_START *)
(* DO NOT EDIT (digest: 626a273da8f5da09ff8c7f97bc223322) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "CPU accelerated code paths";
     ...
     oasis_version = "0.4.5";
     oasis_digest =
       Some "\215\175\151fO\237\223m\188\137\187\152\159\200\226 ";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
