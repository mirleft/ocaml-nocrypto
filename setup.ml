...
(* OASIS_START *)
(* DO NOT EDIT (digest: 370c98f5845153f52c1eb3e9052ef454) *)
(*
...
let setup_t =
  {
               ...
               pre_command =
                 [
                    (OASISExpr.EBool true,
                      Some (("./build/sizes", ["src/native"; "src/"])))
                 ];
                      ...
                      Some
                        (("rm",
                           [
                              "-f";
                              "src/nc_generated.ml";
                              "src/native/nc_generated_stubs.c"
                           ])))
                 ];
               post_command = [(OASISExpr.EBool true, None)]
            };
          distclean_custom =
            {
               pre_command =
                 [
                    (OASISExpr.EBool true,
                      Some (("rm", ["-f"; "src/nc_native_sizes.ml"])))
                 ];
               post_command = [(OASISExpr.EBool true, None)]
            };
          files_ab = [];
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "ffi_gen.ml"});
               Library
                 ({
                     cs_name = "nocrypto";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "Aty\030\174\2403\152+-\232\138\207\000\231Y";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
