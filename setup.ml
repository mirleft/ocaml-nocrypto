...
(* OASIS_START *)
(* DO NOT EDIT (digest: f00ce87158ac1b61c4d502ffbd1ed043) *)
(*
...
let setup_t =
  {
               ...
               pre_command =
                 [
                    (OASISExpr.EBool true,
                      Some
                        (("rm",
                           ["-f"; "src_gen/nocrypto_generated_sizes.ml"])))
                 ];
               post_command = [(OASISExpr.EBool true, None)]
            };
          files_ab = [];
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "\218\186+Dn\029\t#\206\224\182\166l\142\199\241";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
