...
(* OASIS_START *)
(* DO NOT EDIT (digest: 7336229df88d27be17076a11ee3e893c) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_pack = true;
                      lib_internal_modules = ["Native"; "Gcm"; "Ccm"];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\167\164\183>g\131?\174\011tL\192\152\159\188\194";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
