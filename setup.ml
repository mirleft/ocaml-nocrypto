...
(* OASIS_START *)
(* DO NOT EDIT (digest: 4611a34dd67b87c1403301b742b94702) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Notest"; "Dsa_tests"; "Testlib"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = None;
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "\158\030m?\000\228\156\150t\1956\182\143P\221\150";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
